...
WORKDIR /amazon-kinesis-video-streams-producer-sdk-cpp/amazon-kinesis-video-streams-producer-sdk-cpp
RUN git checkout 824de900c2d4b42a403319ace5de9d68ec88b171
WORKDIR kinesis-video-native-build

RUN ./min-install-script
CMD ["./kinesis_video_gstreamer_sample_app Stream1","/dev/video0"]